  ...
  return (
    ...
    >
      <Typography variant="h5">
        Documentación para envio de mensajes mediante APIS
      </Typography>
      ...
      <Typography className={classes.elementMargin} component="div">
        ...
        <ul>
          ...
          El número de envío no debe tener máscara ni caracteres especiales y debe estar compuesto por:
              <ul>
                <li>Código de país - +54</li>
                <li>Característica - sin 0</li>
                <li>Número - sin 15</li>
                <li>Ejemplo: 543874037756</li>
              </ul>
          </li>
        </ul>
      </Typography>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Body: </b> {"{ \"number\": \"543884037756\", \"body\": \"Su Mensaje\" }"}
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Endpoint: </b> {getEndpoint()} <br />
            <b>Método: </b> POST <br />
            <b>Headers: </b> X_TOKEN (token agendado) e Content-Type (multipart/form-data) <br />
            <b>FormData: </b> <br />
            <ul>
              <li>
                <b>number: </b> 543884037756
              </li>
              <li>
                <b>medias: </b> archivo
              </li>
